...
class TemplateVariables:
    ...
    strategy_file: str
    coin_description: Optional[str] = None
    coin_specific_considerations: Optional[str] = None
...
class InstructionTemplateEngine:
    ...
    def _substitute_variables(
        self, template: str, variables: TemplateVariables
    ) -> str:
        ...
        if variables.coin_specific_considerations:
            replacements["COIN_SPECIFIC_CONSIDERATIONS"] = (
                variables.coin_specific_considerations
            )
    ...
    def _process_conditionals(
        self, content: str, variables: TemplateVariables
    ) -> str:
        """
    ...
    def _evaluate_condition(
        self, condition: str, variables: TemplateVariables
    ) -> bool:
        """
    ...
    def get_file_modification_time(self, file_path: Path) -> Optional[float]:
        """
    ...
    def validate_template(self, template: str) -> list[str]:
        ...
        if if_count != endif_count:
            errors.append(
                f"Mismatched conditional tags: {if_count} if, {endif_count} endif"
            )
