...
class TestVisionAnalyzer:
    ...
    async def test_combine_analysis_agreement(
        ...
        sample_technical_indicators["macd"] = {"macd": 500000, "signal": 400000, "histogram": 100000}  # Positive MACD - bullish
    ...
    async def test_combine_analysis_disagreement(
        ...
        sample_technical_indicators["macd"] = {"macd": 500000, "signal": 400000, "histogram": 100000}
    ...
    def test_determine_text_sentiment_bullish(
        ...
        indicators = {
            ...
            "fear_greed_index": 20,  # Fear - contrarian bullish
        }

        sentiment = vision_analyzer._determine_text_sentiment(indicators)
    ...
    def test_determine_text_sentiment_neutral(
        ...
        indicators = {
            "rsi": 50,  # Neutral
            "ma_short": 67000000,
            "ma_long": 67000000,  # Equal
            "macd": {"macd": 0, "signal": 0, "histogram": 0},  # Zero
